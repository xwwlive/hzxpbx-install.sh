...
sudo -u postgres /usr/pgsql-9.5/bin/psql -c "ALTER USER fusionpbx WITH PASSWORD '$database_password';"
sudo -u postgres /usr/pgsql-9.5/bin/psql -c "ALTER USER freeswitch WITH PASSWORD '$database_password';"
